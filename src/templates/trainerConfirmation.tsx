...
export function TrainerConfirmationEmail(data: User) {
  ...
  return (
    <Html>
      <Head />
      <Preview>
        {data.firstName} {data.lastName} su cuenta de Entrenador ha sido
        Aprobada
      </Preview>
      <Body style={styles.main}>
        <Container style={styles.container}>
          <Section style={styles.content}>
            ...
            <Heading style={styles.heading}>Cuenta Aprobada</Heading>

            <Text style={styles.paragraph}>
              <Text style={styles.label}>
                Estimado {data.firstName} {data.lastName}, su cuenta de
                Entrenador ha sido Aprobada
              </Text>
            </Text>

            <Text style={styles.paragraph}>
              <Text style={styles.label}>
                Hacer clic en el siguiente enlace para iniciar sesión
              </Text>
            </Text>
